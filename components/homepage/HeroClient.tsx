...
export default function HeroClient({ announcements }: HeroClientProps) {
  return (
    <section className="relative flex flex-col bg-white">
      ...
      <div className="relative flex items-center pt-16 pb-20 md:pt-20">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-lg text-primary-500 max-w-xl leading-relaxed">
                  ...
                  Nepal and China ensures smooth, reliable guidance at every
                  step.
                </p>
              </div>
            ...
            <div className="lg:col-span-5 relative hidden md:block">
              <div className="relative z-10 aspect-5/4 max-w-lg mx-auto lg:ml-auto overflow-hidden rounded-[3rem] shadow-2xl border-8 border-brand-50">
                <Image
              ...
              <motion.div
                ...
                className="absolute -right-8 -top-8 z-20 hidden md:block bg-white p-5 rounded-4xl shadow-2xl border border-primary-50 max-w-[220px]"
              >
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4, delay: 0.3 }}
                className="absolute -left-12 bottom-20 z-20 hidden md:block bg-white p-6 rounded-4xl shadow-2xl border border-primary-50 max-w-[240px]"
              >
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4, delay: 0.3 }}
                className="absolute -right-12 bottom-4 z-20 hidden md:block bg-white p-5 rounded-4xl shadow-2xl border border-primary-50 max-w-[210px]"
              >
                <div className="flex items-center gap-3 mb-2">
