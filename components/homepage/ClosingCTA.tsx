  ...
  return (
    <section className="py-20 md:py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-2 sm:px-6">
        <div className=" rounded-[2.5rem] p-2 md:p-16 relative overflow-hidden">
          <div className="relative z-10 flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
              ...
              <div className="px-8 md:px-0 space-y-4">
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 p-2 shadow-2xl overflow-hidden relative group">
                <div className="absolute top-4 right-2 bg-white/90 backdrop-blur text-brand-900 text-xs font-bold px-3 py-1.5 rounded-lg shadow-sm z-10 flex items-center gap-1.5">
