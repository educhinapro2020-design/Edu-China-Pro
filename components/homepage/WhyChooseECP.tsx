  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="hidden lg:relative lg:flex flex-col lg:flex-row items-center justify-center gap-8 min-h-[600px]">
          ...
          {[
            {
              ...
              title: "Full Scholarship Strategy",
              desc: "Guidance for CSC, BRI, Provincial, and University-level funding.",
              bg: "bg-brand-50",
            ...
            },
            {
              ...
              title: "Dual-Country Support",
              desc: "From Nepal to China, we are with you until graduation.",
              bg: "bg-brand-50",
              iconColor: "text-brand-600",
            },
            {
            ...
            },
            {
              ...
              title: "SmartScore™",
              desc: "Strategic assessment for admission, scholarship, and visa success.",
              bg: "bg-amber-50",
            ...
            <div
              key={item.title}
              className="bg-white p-6 rounded-2xl shadow-sm border border-primary-100 flex flex-col gap-4"
            >
              <div
                className={`w-11 h-11 ${item.bg} rounded-xl flex items-center justify-center ${item.iconColor}`}
              >
                {item.icon}
              </div>
              <div>
