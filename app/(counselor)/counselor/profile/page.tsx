      ...
      <div className="w-full max-w-4xl mx-auto space-y-6 p-4 sm:p-6 pb-16">
        ...
        <div>
          ...
          <p className="text-primary-500 text-sm mt-0.5">
            Manage your profile information visible to students
          </p>
        </div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="A short description about your experience, specialization, or anything students should know about you..."
              rows={4}
              maxLength={500}
