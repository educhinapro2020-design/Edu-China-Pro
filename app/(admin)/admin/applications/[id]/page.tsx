...
export default function AdminApplicationDetailPage() {
  ...
  const handlePrintForm = useReactToPrint({ contentRef: printRef });
        ...
        <div className="flex flex-col xl:flex-row gap-6 xl:gap-8 items-start">
          <div className="grow w-full xl:w-2/3 space-y-6 min-w-0">
            <div className="bg-white rounded-3xl border border-primary-100 shadow-sm overflow-hidden relative">
              ...
              <div className="p-6 sm:p-8 space-y-6">
                ...
                <div className="rounded-2xl p-4 sm:p-5border border-primary-100 flex flex-wrap items-center gap-4">
          ...
          <div className="w-full lg:w-1/3 shrink-0 flex flex-col gap-6 lg:sticky lg:top-8">
            <div className="bg-white rounded-3xl border border-primary-100 shadow-sm p-6 sm:p-8 flex flex-col gap-6">
              <div>
                <h3 className="text-sm font-bold uppercase tracking-wider text-primary-900 mb-3">
                  Actions
                </h3>
                <Button type="button" size="sm" onClick={handlePrintForm}>
              ...
              <div className="space-y-3 pt-6 border-t border-primary-100">
                ...
                <div className="flex items-center justify-between gap-3">
                  <Link
                    href="/admin/guide/status"
                    className="flex items-center gap-2 text-brand-600 text-xs font-medium hover:underline hover:text-primary-700 transition-colors disabled:opacity-50 mt-1"
                  >
                    Guide
                  </Link>
                  <div className="flex flex-center gap-3">
                    <button
                      ...
                      className="flex justify-end items-center gap-1.5 text-xs text-brand-600 font-medium hover:underline hover:text-primary-700 transition-colors disabled:opacity-50 mt-1"
                    >
                    ...
                    {canUndo && (
                      <button
                        ...
                        disabled={undoing}
                        className="flex justify-end items-center gap-1.5 text-xs text-primary-500 font-medium hover:underline hover:text-primary-700 transition-colors disabled:opacity-50 mt-1"
                      >
            ...
            <div className="py-6 px-6 bg-white rounded-3xl border border-primary-100 shadow-sm overflow-hidden flex flex-col">
              <div className="flex items-center justify-between gap-3 bg-primary-50/30 mb-4">
              ...
              <div className="mt-auto border-t border-primary-100 bg-primary-50/50 pt-4">
                <button
                  type="button"
            ...
            <div className="py-6 px-6 bg-white rounded-3xl border border-primary-100 shadow-sm overflow-hidden flex flex-col">
              ...
              <div className="mt-4 border-t border-primary-100 bg-primary-50/50">
                <button
                  type="button"
